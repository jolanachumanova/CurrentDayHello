package com.hello.currentdayhello.integration;

import com.hello.currentdayhello.CurrentDayHelloApplication;
...
@Slf4j
@SpringBootTest(classes = CurrentDayHelloApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
